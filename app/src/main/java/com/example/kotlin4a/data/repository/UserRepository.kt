package com.example.kotlin4a.data.repository
...
class UserRepository(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION)
{
    ...
    fun addUser(userLocal: UserLocal)
    {
        ...
        values.put(COLUMN_USER_NAME, userLocal.name)
        values.put(COLUMN_USER_EMAIL, userLocal.email)
        values.put(COLUMN_USER_PASSWORD, userLocal.password)
